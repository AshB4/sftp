...
<body>
    ...
    <?php if (isset($user)): ?>
    <a href="<?= site_url('admin/users/toggle/' . $user['id']) ?>">Toggle Active Status</a>
    <?php endif; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filterBtn').click(function() {
                ...
                window.location.href = window.location.pathname + '?start=' + startDate + '&end=' + endDate;
            });
        });
    </script>
</body>
